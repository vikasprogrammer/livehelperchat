...
class erLhcoreClassInstance {
    ...
    public static function getList($paramsSearch = array(), $class = 'erLhcoreClassModelInstance', $tableName = 'lh_instance')
    {
    ...
    public static function getCount($params = array(), $table = 'lh_instance', $operation = 'COUNT(id)')
    {
    	$session = self::getSession();
    ...
    public static function getSession()
    {
        if ( !isset( self::$persistentSession ) )
        {
            self::$persistentSession = new ezcPersistentSession(
                ezcDbInstance::get(),
                new ezcPersistentCodeManager( './pos/lhinstance' )
            );
        }
