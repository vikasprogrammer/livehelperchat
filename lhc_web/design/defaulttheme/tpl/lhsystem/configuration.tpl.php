...
<div class="row">
	<div class="columns small-6">
		...
		<ul class="circle small-list">
		    ...
		    <?php if ($currentUser->hasAccessTo('lhinstance','manageinstances')) : ?>
		    <li><a href="<?php echo erLhcoreClassDesign::baseurl('instance/listinstances')?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','List instances');?></a></li>
		    <?php endif; ?>
